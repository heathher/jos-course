...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	if ((r = file_read(o->o_file, ret->ret_buf, MIN(req->req_n, PGSIZE),
						o->o_fd->fd_offset)) < 0)
		return r;
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	if (o->o_fd->fd_offset + MIN(req->req_n, PGSIZE) > o->o_file->f_size)
	        o->o_file->f_size = o->o_fd->fd_offset + MIN(req->req_n, PGSIZE);
	if ((r = file_write(o->o_file, req->req_buf, MIN(req->req_n, PGSIZE),
						o->o_fd->fd_offset)) < 0)
		return r;
